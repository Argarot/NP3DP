...
Session 005 adds independent emitted-chord geometry analysis, numerical phase-boundary correction and generated reference jobs/diagrams. No new dependency, vendor code, upstream profile or user photograph was published. The same 105-package/six-runtime-notice inventory applies; the distribution license remains undecided.
